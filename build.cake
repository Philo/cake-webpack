...
var solutionPath            = MakeAbsolute(File(Argument("solutionPath", "Cake.Webpack.sln")));
var projectName             = Argument("projectName", "Cake.Webpack");
...
var testAssemblies          = new List<FilePath> { 
                                MakeAbsolute(File("./tests/Cake.Webpack.Tests/bin/" + configuration + "/Cake.Webpack.Tests.dll"))
                              };
    ...
    .Does(() =>
{
    ...
    var nuspec = "./nuspec/" +project.Name +".nuspec";
